...
|----|---------------------|-----------|
| HU-01 | Como usuario quiero registrarme para usar la aplicación | Alta |
| HU-02 | Como usuario quiero iniciar sesión para acceder a mis tareas | Alta |
| HU-03 | Como usuario quiero crear tareas para organizar mis actividades | Alta |
| HU-04 | Como usuario quiero editar tareas para actualizar su información | Alta |
| HU-05 | Como usuario quiero eliminar tareas que ya no necesito | Alta |
| HU-06 | Como usuario quiero marcar tareas como completadas | Media |
| HU-07 | Como usuario quiero clasificar tareas por categorías | Media |
| HU-08 | Como usuario quiero recibir recordatorios | Baja |
